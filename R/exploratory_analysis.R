...
##' @param plot_envelope a logical value indicating if the envelope of sptial independence
...
##' running the function \code{\link{s_variogram}}, the function will display an error message becase no envelope can be generated.
